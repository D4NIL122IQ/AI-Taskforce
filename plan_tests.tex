...
Tests fonctionnels 
& Création d'agents, configuration workflow, exécution collaborative, enrichissement RAG 
& 9 
& Navigateur web \\
...
Ils couvrent les exigences REQ-AGENT-01 et REQ-WKFW-01.
...
\item[Cahier des charges :] AI Taskforce --- Groupe-L3U1 --- Université Paris Cité.
\item[Modèle plan de tests :] David Janiszek --- Université Paris Descartes --- ref. D7, v1.01.
\item[Cahier de recettes v1.2.0 :] KEITA Fodé Laye, 22 février 2026 --- Université Paris Cité.
...
\item[Documentation pytest :] \url{https://docs.pytest.org}
\item[Documentation ReactFlow :] \url{https://reactflow.dev}
\end{description}
